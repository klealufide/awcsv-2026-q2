...
<div class="row justify-content-center">
  <div class="col-lg-7">
    ...
    <h2 class="mb-4"><i class="bi bi-plus-circle me-2"></i>Nueva Tarea</h2>
      ...
      <div class="alert alert-danger" id="messsageCreateTask">
        <i class="bi bi-exclamation-triangle me-2"></i><span>Favor intentar de nuevo</span>
      </div>


    <form method="POST" id="formCreateTask" action="index.php?controller=tareas&action=store">
      ...
      <div class="d-flex gap-2">
        <button type="submit" class="btn btn-primary" id="btnAddTask">
