...
<div class="row justify-content-center">
  <div class="col-lg-7">
    ...
    <div class="alert alert-danger" id="messsageEditTask">
      <i class="bi bi-exclamation-triangle me-2"></i><span>Favor intentar de nuevo</span>
    </div>


    <form method="POST" id="formEditTask" action="index.php?controller=tareas&action=update&id=<?= $tarea['id'] ?>">
      ...
      <div class="d-flex gap-2">
        <button type="submit" id="btnEditTask" class="btn btn-warning">
