...
<div class="row justify-content-center">
  <div class="col-lg-7">
    ...
    <div class="alert alert-danger" id="sectionEditMessage">
      <i class="bi bi-exclamation-triangle me-2"></i><span id="editMessage"></span>
    </div>

    <form method="POST" id="formEditarTarea" action="index.php?controller=tareas&action=update&id=<?= $tarea['id'] ?>">
